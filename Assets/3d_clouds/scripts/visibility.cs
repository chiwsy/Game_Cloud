...
public class visibility : MonoBehaviour
{
		...
		void Update ()
		{
				...
				if (this.name == "cloud1" && this.transform.FindChild ("l1").renderer.enabled == true && act1 == "1") {
						foreach (Transform child in transform) {
				...
				if (this.name == "cloud2" && this.transform.FindChild ("l1").renderer.enabled == true && act2 == "2") {
						foreach (Transform child in transform) {
								child.renderer.enabled = false;
						}
				}
				...
				if (this.name == "cloud3" && this.transform.FindChild ("l1").renderer.enabled == true && act3 == "3") {
						foreach (Transform child in transform) {
								child.renderer.enabled = false;
						}
				}
				...
				if (this.name == "cloud4" && this.transform.FindChild ("l1").renderer.enabled == true && act4 == "4") {
						foreach (Transform child in transform) {
								child.renderer.enabled = false;
						}
				}
				...
				if (this.name == "cloud5" && this.transform.FindChild ("l1").renderer.enabled == true && act5 == "5") {
						foreach (Transform child in transform) {
								child.renderer.enabled = false;
						}
				}
				...
				if (this.name == "cloud6" && this.transform.FindChild ("l1").renderer.enabled == true && act6 == "6") {
						foreach (Transform child in transform) {
								child.renderer.enabled = false;
						}
				}
